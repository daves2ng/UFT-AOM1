...
Browser("Advantage Shopping").Page("Advantage Shopping").Link("Link").Click @@ script infofile_;_ZIP::ssf6.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").Link("View Details").Click @@ script infofile_;_ZIP::ssf7.xml_;_
